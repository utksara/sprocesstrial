# test_coarse_flux.cmd

math dimension=3

pdbSet Topography Simulator LevelSet
pdbSet Grid Resolution 0.05
...
line z location=0.0 spacing=0.1 tag=Front
line z location=1.0 spacing=0.1 tag=Back

region Silicon xlo=Left xhi=Right ylo=Top yhi=Bottom zlo=Front zhi=Back

init

# Define custom material not needed as we use PhotoResist
...
struct tdr=test_coarse_flux_out
