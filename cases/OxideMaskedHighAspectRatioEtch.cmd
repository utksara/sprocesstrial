...
line x location=1 spacing=0.03 tag=Right

line y location=0 spacing=0.03 tag=Top
line y location=3 spacing=0.03 tag=Bottom

line z location=0 spacing=0.03 tag=Front
line z location=1 spacing=0.03 tag=Back
